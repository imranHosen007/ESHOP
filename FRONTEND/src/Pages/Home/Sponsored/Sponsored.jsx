...
const Sponsored = () => {
  return (
    <div className="hidden px-5 py-10 mb-12 bg-white cursor-pointer section rounded-xl sm:block">
      <div className="flex flex-wrap items-center justify-between w-full gap-7">
        <div>
          {" "}
          <img
