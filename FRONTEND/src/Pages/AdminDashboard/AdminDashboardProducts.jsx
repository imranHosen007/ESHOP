...
const AdminDashboardProducts = () => {
  ...
  const newTotalPage = [];
  // ------Pagination---------
  const totalPage = Math.ceil(allProduct.length / itemPerPage);
  const firstIndex = currentPage * itemPerPage;
  const lastIndex = firstIndex - itemPerPage;
  const currentUser = allProduct.slice(lastIndex, firstIndex);
          ...
          <table className="w-full text-sm text-left">
            <thead className="">
              <tr>
                ...
                <th className="px-4 font-semibold text-left">Product Name</th>
                <th className="px-4 font-semibold text-left"> Shop Name</th>
                <th className="px-4 font-semibold text-left">Price</th>
                <th className="px-4 font-semibold text-left">Total Sold</th>
                <th className="px-4 font-semibold text-left">Stock</th>
