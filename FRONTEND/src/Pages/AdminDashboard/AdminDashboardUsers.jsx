...
const AdminDashboardUsers = () => {
  ...
  const newTotalPage = [];
  // ------Pagination---------
  const totalPage = Math.ceil(allUser.length / itemPerPage);
  const firstIndex = currentPage * itemPerPage;
  const lastIndex = firstIndex - itemPerPage;
  const currentUser = allUser.slice(lastIndex, firstIndex);
  ...
  return (
    <div>
      <ToastContainer />
      <h1 className="my-10 text-4xl font-bold text-center">Manage Users</h1>
